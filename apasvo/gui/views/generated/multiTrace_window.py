...
class multiTrace_window(QtCore.QObject):
    ...
    def __init__(self, record, start, end):
        super(multiTrace_window, self).__init__()
        self.record = record
        self.start = start
        self.end = end
        self._abort = False
...
class multiTrace_dialog(QtGui.QDialog):
    """A dialog to show different traces of sismic signal
    ...
    def __init__(self, document, t_start=None, t_end=None, seismic_event=None, parent=None):
        super(multiTrace_dialog, self).__init__(parent)
