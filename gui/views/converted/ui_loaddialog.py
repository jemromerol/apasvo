...
class Ui_LoadDialog(object):
    ...
    def retranslateUi(self, LoadDialog):
        ...
        self.DataTypeComboBox.setItemText(0, QtGui.QApplication.translate("LoadDialog", "Float 16", None, QtGui.QApplication.UnicodeUTF8))
        self.DataTypeComboBox.setItemText(1, QtGui.QApplication.translate("LoadDialog", "Float 32", None, QtGui.QApplication.UnicodeUTF8))
        self.DataTypeComboBox.setItemText(2, QtGui.QApplication.translate("LoadDialog", "Float 64", None, QtGui.QApplication.UnicodeUTF8))
