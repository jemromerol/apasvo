...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuEdit.addAction(self.actionCreate_New_Event)
        self.menuEdit.addAction(self.actionSelect_All_Events)
