...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuOpen_Recent.setIcon(QtGui.QIcon.fromTheme("document-open-recent"))
        #self.menuOpen_Recent.setIconVisibleInMenu(True)
        self.menuOpen_Recent.setObjectName("menuOpen_Recent")
        self.menuEdit = QtGui.QMenu(self.menubar)
        self.menuEdit.setObjectName("menuEdit")
        self.menu_Events = QtGui.QMenu(self.menuEdit)
        self.menu_Events.setObjectName("menu_Events")
        ...
        self.toolBarMedia = QtGui.QToolBar(MainWindow)
        self.toolBarMedia.setMovable(True)
        self.toolBarMedia.setFloatable(True)
        self.toolBarMedia.setObjectName("toolBarMedia")
        MainWindow.addToolBar(QtCore.Qt.TopToolBarArea, self.toolBarMedia)
        ...
        self.actionSettings.setIcon(QtGui.QIcon.fromTheme("preferences-system"))
        ...
        self.actionGenerate_HTML = QtGui.QAction(MainWindow)
        self.actionGenerate_HTML.setEnabled(False)
        self.actionGenerate_HTML.setIcon(QtGui.QIcon.fromTheme("text-html"))
        self.actionGenerate_HTML.setIconVisibleInMenu(True)
        self.actionGenerate_HTML.setObjectName("actionGenerate_HTML")
        ...
        self.actionClearRecent.setIcon(QtGui.QIcon.fromTheme("edit-clear"))
        self.actionClearRecent.setIconVisibleInMenu(True)
        self.actionClearRecent.setObjectName("actionClearRecent")
        self.actionClose = QtGui.QAction(MainWindow)
        self.actionClose.setEnabled(False)
        self.actionClose.setIcon(QtGui.QIcon.fromTheme("window-close"))
        ...
        self.actionCharacteristic_Function.setChecked(True)
        ...
        self.actionCreate_New_Event = QtGui.QAction(MainWindow)
        self.actionCreate_New_Event.setEnabled(False)
        self.actionCreate_New_Event.setObjectName("actionCreate_New_Event")
        ...
        self.actionSelect_All_Events = QtGui.QAction(MainWindow)
        self.actionSelect_All_Events.setEnabled(False)
        self.actionSelect_All_Events.setObjectName("actionSelect_All_Events")
        ...
        self.actionPlay.setVisible(True)
        self.actionPlay.setIcon(QtGui.QIcon.fromTheme("media-playback-start"))
        self.actionPlay.setIconVisibleInMenu(True)
        ...
        self.actionRepeat.setEnabled(True)
        self.actionRepeat.setIcon(QtGui.QIcon.fromTheme("media-playlist-repeat"))
        self.actionRepeat.setIconVisibleInMenu(True)
        self.actionRepeat.setObjectName("actionRepeat")
        self.actionSkip_Backward = QtGui.QAction(MainWindow)
        self.actionSkip_Backward.setEnabled(False)
        self.actionSkip_Backward.setIcon(QtGui.QIcon.fromTheme("media-skip-backward"))
        self.actionSkip_Backward.setIconVisibleInMenu(True)
        self.actionSkip_Backward.setObjectName("actionSkip_Backward")
        ...
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionGenerate_HTML)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionQuit)
        self.menuFile.addSeparator()
        self.menu_Events.addAction(self.actionCreate_New_Event)
        self.menu_Events.addAction(self.actionEdit_Event)
        self.menu_Events.addAction(self.actionSelect_All_Events)
        self.menu_Events.addAction(self.actionDelete_Selected)
        self.menu_Events.addAction(self.actionClear_Event_List)
        self.menuEdit.addAction(self.actionUndo)
        self.menuEdit.addAction(self.actionRedo)
        self.menuEdit.addSeparator()
        self.menuEdit.addAction(self.actionSelect_All)
        self.menuEdit.addSeparator()
        self.menuEdit.addAction(self.menu_Events.menuAction())
        self.menuEdit.addSeparator()
        ...
        self.toolBarMedia.addAction(self.actionSkip_Backward)
        self.toolBarMedia.addAction(self.actionPlay)
        self.toolBarMedia.addAction(self.actionPause)
        self.toolBarMedia.addAction(self.actionStop)
        self.toolBarMedia.addAction(self.actionRepeat)
        ...
        self.thresholdCheckBox = QtGui.QCheckBox("Enable threshold", parent=self.toolBarAnalysis)
        self.toolBarAnalysis.addWidget(self.thresholdCheckBox)
        self.toolBarAnalysis.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_Events.setTitle(QtGui.QApplication.translate("MainWindow", "&Events", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.toolBarMedia.setWindowTitle(QtGui.QApplication.translate("MainWindow", "toolBar", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionGenerate_HTML.setText(QtGui.QApplication.translate("MainWindow", "Generate &HTML...", None, QtGui.QApplication.UnicodeUTF8))
        self.actionGenerate_HTML.setShortcut(QtGui.QApplication.translate("MainWindow", "Ctrl+H", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionSelect_All.setShortcut(QtGui.QApplication.translate("MainWindow", "Ctrl+E", None, QtGui.QApplication.UnicodeUTF8))
        self.actionCreate_New_Event.setText(QtGui.QApplication.translate("MainWindow", "Create &New Event", None, QtGui.QApplication.UnicodeUTF8))
        self.actionEdit_Event.setText(QtGui.QApplication.translate("MainWindow", "&Edit Event...", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSelect_All_Events.setText(QtGui.QApplication.translate("MainWindow", "Select &All Events", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionPlay.setToolTip(QtGui.QApplication.translate("MainWindow", "Play", None, QtGui.QApplication.UnicodeUTF8))
        self.actionStop.setText(QtGui.QApplication.translate("MainWindow", "Stop", None, QtGui.QApplication.UnicodeUTF8))
        self.actionStop.setToolTip(QtGui.QApplication.translate("MainWindow", "Stop", None, QtGui.QApplication.UnicodeUTF8))
        self.actionRepeat.setText(QtGui.QApplication.translate("MainWindow", "Repeat", None, QtGui.QApplication.UnicodeUTF8))
        self.actionRepeat.setToolTip(QtGui.QApplication.translate("MainWindow", "Repeat", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSkip_Backward.setText(QtGui.QApplication.translate("MainWindow", "Skip Backward", None, QtGui.QApplication.UnicodeUTF8))
