...
def main(argv=None):
    ...
    \033[1m>> python apasvo_generator.py -o example.out -f 100 -l 600 -t 200 -ep 5 -np 0\033[0m
    ...
    \033[1m>> python apasvo_generator.py meq.bin meq2.txt -f 50 -np 2 -fir coeffs.txt\033[0m
    ...
    \033[1m>> python apasvo_generator.py -o eq.bin -n 500 -l 3600 -t 100 -ep 2 -np 2 --f-low 4.0 --f-high 25.0\033[0m
    ...
    \033[1m>> python apasvo_generator.py -o eq.txt -n 30 --output-format text @settings.txt\033[0m
